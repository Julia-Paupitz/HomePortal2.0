...
function UnfinishedAppCard() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group block bg-navy-800 rounded-2xl p-6 sm:p-8 hover:bg-navy-500 transition-colors"
    >
      {/* Icon + status */}
      <div className="flex items-start justify-between mb-5">
        ...
        <span className="text-[11px] font-semibold uppercase tracking-widest text-teal-50/70 pt-1">
          In Progress
        </span>
      </div>
      ...
      {/* CTA */}
      <div className="inline-flex items-center gap-2 bg-teal-700 group-hover:bg-teal-50 text-white group-hover:text-teal-700 font-semibold text-sm px-5 py-2.5 rounded-xl transition-colors">
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-navy-800">Applications</h2>
        <UnfinishedAppCard />
        <button className="bg-gray-100 hover:bg-gray-200 text-navy-800 font-semibold text-sm px-5 py-2.5 rounded-full transition-colors">
