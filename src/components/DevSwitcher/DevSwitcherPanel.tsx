...
import { useDevSwitcher, type GlobalState, type LayoutMode, type NotificationFlags, type LoanNavMode } from '@/context/DevSwitcherContext'
...
export function DevSwitcherPanel() {
  const { isOpen, setIsOpen, layoutMode, setLayoutMode, globalState, setGlobalState, componentVariations, setComponentVariation, notifications, setNotification, loanNavMode, setLoanNavMode, reset } = useDevSwitcher()
